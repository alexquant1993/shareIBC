...
usethis::use_mit_license(copyright_holder = "Immanuel Baptist Church" )  # You can set another license here
...
golem::use_favicon("C:/Users/aarro/OneDrive/Documents/socialministry/favicon/favicon.ico") # path = "path/to/ico". Can be an online file. 
